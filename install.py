...
def install_packages():
    try:
        with open("requirements.txt", "r") as file:
            packages = [line.strip() for line in file if line.strip()]  # Rimuovo spazi e righe vuote
    except FileNotFoundError:
        print("requirements.txt non è stato trovato. Per favore assicurati che il file si trovi nella directory.")
        sys.exit(1)
