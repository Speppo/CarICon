...
df1 = pd.read_csv("risultati/risultati_adaboost_clustered_plus_prolog_generated.csv")
...
df2 = pd.read_csv("risultati/risultati_decision_tree_clustered_plus_prolog_generated.csv")
...
df3 = pd.read_csv("risultati/risultati_knn_clustered_plus_prolog_generated.csv")
...
df4 = pd.read_csv("risultati/risultati_random_forest_clustered_plus_prolog_generated.csv")
