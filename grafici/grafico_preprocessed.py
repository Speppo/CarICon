...
df1 = pd.read_csv("risultati/risultati_adaboost_preprocessed.csv")
...
df2 = pd.read_csv("risultati/risultati_decision_tree_preprocessed.csv")
...
df3 = pd.read_csv("risultati/risultati_knn_preprocessed.csv")
...
df4 = pd.read_csv("risultati/risultati_random_forest_preprocessed.csv")
